...
<body class="bg-gray-100">
    ...
    <nav class="relative z-30 p-4 glass-effect mb-6">
        <div class="container mx-auto flex justify-between items-center">
            <a href="<?php echo URLROOT; ?>/dashboard" class="text-xl font-bold text-gray-800"><?php echo SITENAME; ?></a>
            <ul class="flex items-center space-x-6">
                ...
                <?php else : ?>
                    ...
                    <li>
                        <a href="<?php echo URLROOT; ?>/user/register" class="bg-pink-500 text-white font-bold py-2 px-4 rounded-full hover:bg-pink-600 transition duration-300">สมัครสมาชิก</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
