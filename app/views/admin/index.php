...
<div class="p-8 rounded-lg glass-effect">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo URLROOT; ?>/admin/addUser" class="bg-pink-500 text-white font-bold py-2 px-4 rounded-full hover:bg-pink-600">เพิ่มผู้ใช้ใหม่</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="p-3 flex items-center space-x-2">
                        <a href="<?php echo URLROOT; ?>/admin/editUser/<?php echo $user->id; ?>" class="text-blue-500 hover:text-blue-700">แก้ไข</a>
